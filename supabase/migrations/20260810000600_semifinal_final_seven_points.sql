-- Semifinal (4 players remaining -> 2 matches) and Final (2 players
-- remaining -> 1 match) rounds of the single-elimination bracket are now
-- played to 7 points instead of the tournament's normal target_score, since
-- those matches decide the placings that matter most.
